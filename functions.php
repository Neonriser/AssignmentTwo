...
//custom functions (& possibly a post type)

function character_profile(){
	$labels = array(
		'name'			=> ('Characters'),
		'singular_name' => ('Character'),
		'menu_name'		=> ('Character Profiles')
	);
	$args = array(
		'label'			=> ('characters'),
		...
		'menu_icon'		=>'dashcons-format-groups',
...
add_action('init','character_profile', 0);
/*
//shortcode

function character_shortcode(){
$args = array();
...
if($query->have_posts()) :
	while($query-have_posts()) :
		$query->the_post();
		$result .= '<div>';
		$result .= '<span class="character-img">' . get_the_post_thumbnail() . '</span>';
...
add_shortcode('characters','character_shortcode');
...
function register_widget_areas(){
	...
	register_sidebar(array(
		'name' 			=> 'Picture',
		'id' 			=> 'profile-pic',
		'description' 	=> 'The picture of the character.',
